...
const HeroSection = () => {
  ...
  return (
    <section className="relative z-0 w-full overflow-hidden bg-[#070812] text-white">
      {/* Background */}
      <div
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1280px] px-6 pt-[140px] pb-0 sm:px-8 lg:px-10 lg:pt-[160px]">
        <div className="grid items-start gap-12 lg:grid-cols-2 lg:gap-14">
          ...
          >
            ...
            <h1 className="relative z-20 text-5xl font-semibold leading-[0.98] tracking-[-0.045em] text-white sm:text-6xl lg:text-[68px]">
              Turn Attention
              <br />
              Into{" "}
            ...
            <p className="relative z-20 mt-6 max-w-[520px] text-base leading-7 text-white/55 sm:text-lg">
            ...
            <div className="relative z-20 mt-7 flex flex-col gap-3 sm:flex-row">
              <a
                href="#contact"
                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-[#665cff] px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-[#766dff]"
              >
          ...
          {/* RIGHT DASHBOARD */}
          <div
            className="relative z-20 flex w-full justify-center lg:justify-end"
            style={{ opacity: 1, visibility: "visible" }}
          >
